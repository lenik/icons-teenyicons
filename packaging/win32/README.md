...
.\build.ps1 -Name icons-teenyicons -Version 1.2.3
```
...
```
<project>/.config/icons-teenyicons/<packaging>.build-host
$HOME/.config/icons-teenyicons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-teenyicons
```
